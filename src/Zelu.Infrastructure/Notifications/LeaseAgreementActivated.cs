...
{
    public class LeaseAgreementActivated : INotification
    {
        public LeaseAgreementActivated(string externalId, string leaseEntityId, string propertyEntityId, DateTimeOffset startDate, DateTimeOffset? endDate, long leaseAmount, string? statusKey,
